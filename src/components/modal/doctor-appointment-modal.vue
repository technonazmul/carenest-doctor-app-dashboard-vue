                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <div class="input-icon-end position-relative">  
                                <a-date-picker v-model:value="valueOne" class="form-control datetimepicker" placeholder="dd/mm/yyyy" />
                            </div>
                        </div>
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <div class="input-icon-end position-relative">  
                                <a-time-picker v-model:value="valueThree" class="form-control timepicker" />
                            </div>
                        </div>
                    </div> <!-- end col-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label mb-1 text-dark fs-14 fw-medium"> Date of Appointment <span class="text-danger">*</span></label>
                            <div class="input-icon-end position-relative">  
                                <a-date-picker v-model:value="valueTwo" class="form-control datetimepicker" placeholder="20/08/2025" />
                            </div>
                        </div>
                    </div> <!-- end col-->
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label mb-1 text-dark fs-14 fw-medium"> Time <span class="text-danger">*</span></label>
                            <div class="input-icon-end position-relative">  
                                <a-time-picker v-model:value="valueFour" class="form-control timepicker" />
                            </div>
                        </div>
                    </div> <!-- end col-->
        ...
        <div class="offcanvas-body pt-0 px-0">
            ...
            <div class="px-3 my-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div>  
                        <a href="javascript:void(0);" class="btn-primary btn btn-sm rounded d-flex align-items-center"> 
