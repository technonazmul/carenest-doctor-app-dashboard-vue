            ...
            <div class="col-lg-3">
              <div class="text-start">
                <router-link
                  ...
                  ><i class="ti ti-user-cog me-2 text-dark"> </i> Profile
                  Settings
                </router-link>
                <router-link
                  to="/doctor/settings/doctors-password-settings"
                  class="d-block w-100 btn btn-md border rounded fs-14 fw-medium text-primary text-start mb-1 active"
                >
                  <i class="ti ti-lock-star me-2 text-primary"> </i> Change
                  Password
                </router-link>
                <router-link
                  ...
                  class="btn btn-md rounded fs-14 fw-medium text-dark mb-1 w-100 justify-content-start"
                >
                  <i class="ti ti-bell me-2 text-dark"> </i> Notifications
                </router-link>
              </div>
            </div>
            <!-- end col -->
                      ...
                      <div class="col-lg-7">
                        <div class="position-relative">
                          ...
                          >
                            ...
                            >
                              <i
                                class="ti toggle-password text-dark fs-14"
                                :class="{
                                  'ti-eye-slash': showPassword,
                      ...
                      <div class="col-lg-7">
                        <div class="position-relative">
                          ...
                          >
                            ...
                            >
                              <i
                                class="ti toggle-passwords ti-eye-off text-dark fs-14"
                                :class="{
                                  'ti-eye-slash': showPasswordOne,
                                  'ti-eye-off': !showPasswordOne,
                                }"
                              ></i>
                            </span>
                          </div>
