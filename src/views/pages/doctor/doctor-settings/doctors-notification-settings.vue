            ...
            <div class="col-lg-3">
              <div class="text-start">
                <router-link
                  ...
                  class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"
                >
                  <i class="ti ti-user-cog me-2 text-dark"> </i>Profile Settings
                </router-link>
                <router-link
                ...
                <router-link
                  ...
                  class="d-block w-100 btn btn-md border rounded fs-14 fw-medium text-primary text-start mb-1"
                >
