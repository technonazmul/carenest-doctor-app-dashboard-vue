                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="text-start">
                                <router-link to="/doctor/settings/doctors-profile-settings" class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i class="ti ti-user-cog me-2 text-dark"> </i>Profile Settings  </router-link>
                                <router-link to="/doctor/settings/doctors-password-settings" class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i class="ti ti-lock-star me-2 text-dark"> </i> Change Password </router-link>
                                <router-link to="/doctor/settings/doctors-notification-settings" class="d-block w-100 btn btn-md border rounded fs-14 fw-medium text-primary text-start mb-1 "> <i class="ti ti-bell me-2 text-primary active"> </i>Notifications </router-link>
                            </div>
