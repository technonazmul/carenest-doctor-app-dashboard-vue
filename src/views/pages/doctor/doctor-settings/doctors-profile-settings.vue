  ...
  data() {
    return {
      ...
      State: [
        ...
        { label: "Ontario", name: "Ontario" },
        { label: "England", name: "England" },
        { label: "Bavaria", name: "Bavaria" },
      ],
      City: [
        { label: "Los Angeles", name: "Los Angeles" },
        { label: "Toronto", name: "Toronto" },
        { label: "London", name: "London" },
        { label: "Munich", name: "Munich" },
      ],
    };
  },
};
