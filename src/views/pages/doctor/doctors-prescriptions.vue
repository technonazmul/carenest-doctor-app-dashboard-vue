        ...
        <div class="text-end d-flex">
          ...
          <div class="dropdown me-1">
            <a
              ...
              class="btn btn-md fs-14 fw-normal border bg-white rounded text-dark d-inline-flex align-items-center fw-regular"
        ...
        >
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'Prescription_ID'">
              <router-link to="/doctor/doctors-prescription-details">{{
            ...
            <template v-if="column.key === 'action'">
              <div class="action-item">
                ...
                <ul class="dropdown-menu p-2">
                  <li>
                    <router-link
                      to="/doctor/doctors-prescription-details"
...
const columns = [
  {
    ...
    sorter: {
      compare: (a, b) =>
        a.Prescription_ID.toLowerCase() > b.Prescription_ID.toLowerCase()
          ? -1
          : 1,
    },
  },
  ...
  },
  {
    ...
    sorter: {
      compare: (a, b) =>
        a.Prescribed_On.toLowerCase() > b.Prescribed_On.toLowerCase() ? -1 : 1,
    },
  },
  {
    title: "",
