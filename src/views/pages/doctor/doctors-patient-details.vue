    ...
    <div class="content">
              ...
              <div>
                ...
                <div class="d-flex align-items-center flex-wrap">
                  <p class="mb-0 d-inline-flex align-items-center">
                    ...
                    <span class="text-dark ms-1">+1 54546 45648</span>
                  </p>
                  <span class="mx-2 text-light">|</span>
                  <p class="mb-0 d-inline-flex align-items-center">
                    <i class="ti ti-calendar-time me-1 text-dark"></i>Last
                    Visited : <span class="text-dark ms-1">30 Apr 2025</span>
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="d-flex align-items-center mb-3">
                    <span
                      class="avatar rounded-2 bg-light text-dark flex-shrink-0 me-2 border"
                      ><i class="ti ti-hexagons fs-16"></i
                    ></span>
                    <div>
      ...
      <div class="tab-content">
        <div class="tab-pane show active" id="appointments">
          <appointment-details-table></appointment-details-table>
        </div>
        <div class="tab-pane" id="transactions">
          <transactions-details-table></transactions-details-table>
        </div>
      </div>
      <!-- tab content end -->
    </div>
