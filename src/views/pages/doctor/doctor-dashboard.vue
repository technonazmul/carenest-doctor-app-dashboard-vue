      ...
      >
        ...
        <div class="d-flex align-items-center flex-wrap gap-2">
          ...
          <a
            ...
            ><i class="ti ti-calendar-time me-1"></i>Schedule Availability</a
          >
        </div>
      </div>
      <!-- End Page Header -->
              ...
              <div class="d-flex align-items-end">
                <div id="s-col-5" class="chart-set">
                  <apexchart
                    ...
                    height="60"
                    width="100"
                    :options="sColChart5.sChart5"
                    :series="sColChart5.series"
                  ></apexchart>
                </div>
                <span
                  class="badge fw-medium badge-soft-success flex-shrink-0 ms-2"
              ...
              <div class="d-flex align-items-end">
                <div id="s-col-6" class="chart-set">
                  <apexchart
                    ...
                    height="60"
                    width="100"
                    :options="sColChart6.sChart6"
                    :series="sColChart6.series"
                  ></apexchart>
                </div>
                <span
                  class="badge fw-medium badge-soft-danger flex-shrink-0 ms-2"
              ...
              <div class="d-flex align-items-end">
                <div id="s-col-7" class="chart-set">
                  <apexchart
                    ...
                    height="60"
                    width="100"
                    :options="sColChart7.sChart7"
                    :series="sColChart7.series"
                  ></apexchart>
                </div>
                <span
                  class="badge fw-medium badge-soft-success flex-shrink-0 ms-2"
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center gap-2 flex-wrap mb-3">
                <p class="mb-0 d-inline-flex align-items-center">
                  <i class="ti ti-calendar-time text-dark me-1"></i>Monday, 31
                  Mar 2025
                </p>
                <p class="mb-0 d-inline-flex align-items-center">
                  <i class="ti ti-clock text-dark me-1"></i>06:30 PM
                </p>
              </div>
              <div class="row">
                <div class="col">
              ...
              <div class="d-flex align-items-center gap-2">
                <a href="javascript:void(0);" class="btn btn-dark w-100"
                  ><i class="ti ti-brand-hipchat me-1"></i>Chat Now</a
                >
                <a
                  href="javascript:void(0);"
                  class="btn btn-outline-white w-100"
                  ><i class="ti ti-video me-1"></i>Video Consutation</a
                >
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-8 d-flex">
          ...
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body pb-0">
              <div
                class="d-flex align-items-center justify-content-end gap-2 mb-1 flex-wrap mb-3"
              >
                <p class="mb-0 d-inline-flex align-items-center">
                  <i class="ti ti-point-filled me-1 fs-18 text-primary"></i
                  >Total Appointments
                </p>
                <p class="mb-0 d-inline-flex align-items-center">
                  <i class="ti ti-point-filled me-1 fs-18 text-success"></i
                  >Completed Appointments
                </p>
              </div>
              <div class="chart-set" id="s-col-20">
                <apexchart
                  type="line"
                  height="250"
                  :options="sColChart20.sChart20"
                  :series="sColChart20.series"
                ></apexchart>
              </div>
            </div>
          </div>
      ...
      <div class="row row-cols-1 row-cols-xl-6 row-cols-md-3 row-cols-sm-2">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span class="avatar bg-primary rounded-2 fs-20 d-inline-flex mb-2"
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span
                class="avatar bg-secondary rounded-2 fs-20 d-inline-flex mb-2"
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span class="avatar bg-success rounded-2 fs-20 d-inline-flex mb-2"
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span class="avatar bg-danger rounded-2 fs-20 d-inline-flex mb-2"
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span class="avatar bg-info rounded-2 fs-20 d-inline-flex mb-2"
        ...
        <div class="col">
          <div class="card shadow-sm">
            <div class="card-body">
              <span
                class="avatar bg-soft-success text-success rounded-2 fs-20 d-inline-flex mb-2"
                ...
                <table class="table border">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Online</td>
                      <td>
                        <span class="badge bg-warning fw-medium"
                          >Checked in</span
                        >
                      </td>
                    ...
                    <tr>
                      ...
                      <td>In-Person</td>
                      <td>
                        <span class="badge bg-info fw-medium">Schedule</span>
                      </td>
      ...
      <div class="row">
          ...
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body">
              ...
              >
                ...
                <p class="mb-0 d-inline-flex align-items-center">
                  <i class="ti ti-clock me-1"></i>11:00 PM - 12:30 PM
                </p>
              </div>
              <div
                class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2"
              ...
              >
                ...
                <p class="mb-0 d-inline-flex align-items-center text-danger">
                  <i class="ti ti-clock me-1"></i>Closed
                </p>
              </div>
              <a
                href="javascript:void(0);"
                class="btn btn-light w-100 mt-2 fs-13"
                >Edit Availability</a
              >
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-6 d-flex">
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body">
              <div id="circle-chart-2" class="chart-set">
                <apexchart
                  type="donut"
                  height="270"
                  width="100%"
                  :options="sCirclechart.scircle"
                  :series="sCirclechart.series"
                ></apexchart>
              </div>
              <div
              ...
              >
                <div class="text-center">
                  <p class="d-flex align-items-center mb-1 fs-13">
                    <i class="ti ti-circle-filled text-success fs-10 me-1"></i
                    >Completed
                  </p>
                ...
                <div class="text-center">
                  <p class="d-flex align-items-center mb-1 fs-13">
                    <i class="ti ti-circle-filled text-warning fs-10 me-1"></i
                    >Pending
                  </p>
                ...
                <div class="text-center">
                  <p class="d-flex align-items-center mb-1 fs-13">
                    <i class="ti ti-circle-filled text-danger fs-10 me-1"></i
                    >Cancelled
                  </p>
...
export default {
  data() {
    return {
      sCirclechart: sCirclechart,
      sColChart20: sColChart20,
      sColChart7: sColChart7,
      sColChart6: sColChart6,
      sColChart5: sColChart5,
    };
  },
};
</script>
