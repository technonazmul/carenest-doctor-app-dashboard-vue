    ...
    <div class="content content-two">
      ...
      <div class="mb-3 pb-3 border-bottom">
        <div class="d-flex align-items-center">
          <h4 class="fw-bold mb-0 me-2">Chat</h4>
        </div>
      </div>
      <!-- End Page Header -->
          ...
          <div id="chats" class="sidebar-content active slimscroll">
              <div class="slimscroll">
                ...
                <div class="sidebar-body chat-body" id="chatsidebar">
                  ...
                  >
                    <h6 class="chat-title mb-0">All Chats</h6>
                  </div>

                  <div class="chat-users-wrap">
                    <div class="chat-list">
                      <router-link to="/applications/chat" class="chat-user-list">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-1">
                          <li>
                            <a class="dropdown-item" href="#"
                              ><i class="ti ti-box-align-right me-2"></i>Archive
                              Chat</a
                            >
                          </li>
                          <li>
                            <a class="dropdown-item" href="#"
                              ><i class="ti ti-heart me-2"></i>Mark as
                              Favourite</a
                            >
                          </li>
                          <li>
                      ...
                      <router-link to="/applications/chat" class="chat-user-list">
                        ...
                        <div class="chat-user-info">
                          <div class="chat-user-msg">
                            ...
                            <p class="text-danger">
                              <i class="ti ti-video-off me-2"></i>Missed Video
                              Call
                            </p>
                          </div>
                          <div class="chat-user-time">
                    ...
                    <div class="chat-list">
                      <router-link to="/applications/chat" class="chat-user-list mb-0">
                        <div class="avatar avatar-lg online me-2">
                          <img
                        ...
                        <div class="chat-user-info">
                          <div class="chat-user-msg">
                            ...
                            <p class="text-success">
                              <i class="ti ti-video-plus text-success me-2"></i
                              >Incoming Video Call
                            </p>
                          </div>
                          <div class="chat-user-time">
                  ...
                  <div class="chats">
                    ...
                    <div class="chat-content">
                      <div class="chat-info">
                        ...
                        <div class="chat-actions">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end p-1">
                            <li>
                              <a class="dropdown-item" href="#"
                                ><i class="ti ti-heart me-2"></i>Reply</a
                              >
                            </li>
                            <li>
                              <a class="dropdown-item" href="#"
                            ...
                            <li>
                              <a class="dropdown-item" href="#"
                                ><i class="ti ti-box-align-right me-2"></i
                                >Archeive Chat</a
                              >
                            </li>
                            <li>
                      ...
                      <div class="chat-profile-name">
                        <h6>
                          Anthony Lewis<i
                            class="ti ti-circle-filled fs-7 mx-2"
                          ></i
                    ...
                    <div class="chat-content">
                      <div class="chat-info">
                        ...
                        <div class="chat-actions">
                          ...
                          <ul
                            class="dropdown-menu dropdown-menu-end p-1 list-unstyled"
                          >
                            <li>
                              <a class="dropdown-item" href="#"
                                ><i class="ti ti-heart me-2"></i>Reply</a
              ...
              <div class="chat-footer-wrap">
                ...
                <div class="form-item emoj-action-foot">
                  ...
                  <div class="emoj-group-list-foot down-emoji-circle">
                    <ul class="list-unstyled">
                      <li>
                        <a href="javascript:void(0);"
                          ><img src="@/assets/img/emojis/emoji-02.svg" alt="Icon"
                        /></a>
                      </li>
                      <li>
                        <a href="javascript:void(0);"
                          ><img src="@/assets/img/emojis/emoji-05.svg" alt="Icon"
                        /></a>
                      </li>
                      <li>
                        <a href="javascript:void(0);"
                          ><img src="@/assets/img/emojis/emoji-06.svg" alt="Icon"
                        /></a>
                      </li>
                      <li>
                        <a href="javascript:void(0);"
                          ><img src="@/assets/img/emojis/emoji-07.svg" alt="Icon"
                        /></a>
                      </li>
                      <li>
                        <a href="javascript:void(0);"
                          ><img src="@/assets/img/emojis/emoji-08.svg" alt="Icon"
                        /></a>
                      </li>
                      <li class="add-emoj">
                        <a href="javascript:void(0);"
                ...
                <div class="form-item">
                  ...
                  <div class="dropdown-menu dropdown-menu-end p-1">
                    <a href="#" class="dropdown-item"
                      ><i class="ti ti-camera-selfie me-2"></i>Camera</a
                    >
                    <a href="#" class="dropdown-item"
                      ><i class="ti ti-photo-up me-2"></i>Gallery</a
                    >
                    <a href="#" class="dropdown-item"
                      ><i class="ti ti-music me-2"></i>Audio</a
                    >
                    <a href="#" class="dropdown-item"
                      ><i class="ti ti-map-pin-share me-2"></i>Location</a
                    >
                    <a href="#" class="dropdown-item"
                      ><i class="ti ti-user-check me-2"></i>Contact</a
                    >
                  </div>
                </div>
                <div class="form-btn">
