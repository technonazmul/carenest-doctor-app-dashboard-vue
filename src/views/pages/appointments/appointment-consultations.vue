  ...
  <div class="page-wrapper consultation-custom">
    ...
    <div class="content">
              ...
              <div class="d-flex align-items-center gap-3">
                ...
                <div class="">
                  ...
                  <p class="text-dark m-0">
                    <span class="text-body"> Reason : </span> Pain near left chest, Pelvic
                    salinity
                  </p>
                </div>
              </div>
          ...
          <div class="complaint-list">
            ...
            <div class="mb-3 complaint-list-item">
              ...
              <div class="input-group">
                ...
                <a
                  href="#"
                  class="remove-complaint ms-3 p-2 bg-light text-danger rounded d-flex align-items-center justify-content-center"
            ...
            <div class="complaint-list-item">
              <div class="input-group">
                <input
                  ...
                  value="Headache in Leftside"
                />
                <a
                  href="#"
                  class="add-complaint ms-3 p-2 bg-light text-dark rounded d-flex align-items-center justify-content-center"
          ...
          <div class="medication-list">
            ...
            <div class="row medication-list-item">
              ...
              <div class="col-lg-1 px-xxl-3">
                ...
                <a
                  href="#"
                  class="remove-medication ms-3 p-2 bg-light text-danger rounded d-flex align-items-center justify-content-center"
                  ><i class="ti ti-trash fs-16"></i
                ></a>
              </div>
            </div>
            ...
            <div class="row medication-list-item">
              ...
              <div class="col-lg-1 px-xxl-3">
                ...
                <a
                  href="#"
                  class="add-medication ms-3 p-2 mt-1 bg-light text-dark rounded d-flex align-items-center justify-content-center"
                  ><i class="ti ti-plus fs-16"></i
                ></a>
              </div>
            </div>
        ...
        <div class="card-body advices-list pb-0">
          ...
          <div class="mb-3 advices-list-item">
            ...
            <div class="input-group">
              ...
              <a
                href="#"
                class="add-advices ms-3 p-2 bg-light text-dark rounded d-flex align-items-center justify-content-center"
                ><i class="ti ti-plus fs-16"></i
              ></a>
            </div>
          </div>
      ...
      <div class="card rounded-0">
        ...
        <div class="card-body invest-list pb-0">
          ...
          <div class="mb-3 invest-list-item">
            <label class="form-label mb-1 text-dark fs-14 fw-medium"
              >Investigation & Procedure</label
            >
            <div class="input-group">
              <input type="text" class="form-control rounded" />
              <a
                href="#"
                class="add-invest ms-3 p-2 bg-light text-dark rounded d-flex align-items-center justify-content-center"
                ><i class="ti ti-plus fs-16"></i
              ></a>
            </div>
          </div>
              ...
              <div class="col-lg-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <a
                      href="#"
                      class="remove-invoice ms-3 p-2 bg-light text-danger rounded d-flex align-items-center justify-content-center"
                      ><i class="ti ti-trash fs-16"></i
                    ></a>
                  </div>
                </div>
              ...
              <div class="col-lg-4">
                <div class="mb-3">
                  <div class="input-group">
                    ...
                    <a
                      href="#"
                      class="add-invoice ms-3 p-2 bg-light text-dark rounded d-flex align-items-center justify-content-center"
                      ><i class="ti ti-plus fs-16"></i
                    ></a>
                  </div>
                </div>
      ...
      <div class="d-flex gap-2 align-items-center justify-content-end mb-4">
        <a href="" class="btn btn-md bg-light text-dark fs-13 fw-medium rounded">
          Cancel
        </a>
        <a
          href=""
  ...
  data() {
    return {
      ...
      Medicine: [
        ...
        { label: "Axer 90MG Tab", value: "Axer 90MG Tab" },
        { label: "Ramistar XL 2.5", value: "Ramistar XL 2.5" },
      ],
      Frequency: [
      ...
      Service: [
        ...
        { label: "Eye Checkup", value: "Eye Checkup" },
        { label: "Blood Test", value: "Blood Test" },
        { label: "Skin Allergy Test", value: "Skin Allergy Test" },
      ],
      Payment: [
