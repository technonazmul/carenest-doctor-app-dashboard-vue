              ...
              <form>
                <div id="basicwizard">
                  ...
                  <div class="tab-content b-0 mb-0">
                    ...
                    <div
                      class="d-flex wizard justify-content-between flex-wrap gap-2 mt-3"
                    >
                      <div class="first">
                    ...
                    <div class="tab-pane" id="account-2">
                      <div class="row">
                        <div class="col-12">
                          ...
                          <div class="row mb-3">
                            <label class="col-md-3 col-form-label" for="confirm1"
                              >Re Password</label
                            >
                            <div class="col-md-9">
                              <input
                      ...
                      >
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="row mb-3">
                              <label class="col-md-3 col-form-label" for="confirm3"
                                >Re Password</label
                              >
                              <div class="col-md-9">
                                <input
