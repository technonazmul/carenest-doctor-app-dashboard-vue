  ...
  <div class="page-wrapper cardhead">
    ...
    <div class="content">
      ...
      <div class="page-header">
        <div class="row">
          <div class="col-sm-12">
            <h3 class="page-title">Tabler Icon</h3>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="mb-2">
                <code>&lt;i class="ti ti-ICON_NAME"&gt;&lt;/i&gt;</code>. For more
                information
                <a href="https://tabler-icons.io/" target="_blank" class="text-primary"
                  >click here</a
                >.
              </p>
              <div class="icons-items">
                <div class="icons-list">
                  <div class="icons-list-item">
                    <i class="ti ti-home" data-bs-toggle="tooltip" title="ti ti-home"></i>
                  </div>
                  ...
                  <div class="icons-list-item">
                    <i class="ti ti-bell" data-bs-toggle="tooltip" title="ti ti-bell"></i>
                  </div>

                  <div class="icons-list-item">
                    <i
                      class="ti ti-mail-cog"
                      data-bs-toggle="tooltip"
                  ...
                  <div class="icons-list-item">
                    <i
                      class="ti ti-circle-arrow-right-filled"
                      data-bs-toggle="tooltip"
