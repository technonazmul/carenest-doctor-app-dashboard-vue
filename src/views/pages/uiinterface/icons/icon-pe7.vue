            ...
            <div class="card-body">
              <div class="icons-items">
                <ul class="icons-list">
                  ...
                  <li>
                    <i class="pe-7s-helm" data-bs-toggle="tooltip" title="pe-7s-helm"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-leaf" data-bs-toggle="tooltip" title="pe-7s-leaf"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-male" data-bs-toggle="tooltip" title="pe-7s-male"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-map-2"
                  ...
                  <li>
                    <i class="pe-7s-wine" data-bs-toggle="tooltip" title="pe-7s-wine"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-cash" data-bs-toggle="tooltip" title="pe-7s-cash"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-close"
                  ...
                  <li>
                    <i class="pe-7s-safe" data-bs-toggle="tooltip" title="pe-7s-safe"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-volume2"
                  ...
                  <li>
                    <i class="pe-7s-user" data-bs-toggle="tooltip" title="pe-7s-user"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-upload"
                  ...
                  <li>
                    <i class="pe-7s-star" data-bs-toggle="tooltip" title="pe-7s-star"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-speaker"
                  ...
                  <li>
                    <i class="pe-7s-film" data-bs-toggle="tooltip" title="pe-7s-film"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-science"
                  ...
                  <li>
                    <i class="pe-7s-disk" data-bs-toggle="tooltip" title="pe-7s-disk"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-ribbon"
                  ...
                  <li>
                    <i class="pe-7s-prev" data-bs-toggle="tooltip" title="pe-7s-prev"></i>
                  </li>
                  <li>
                    <i class="pe-7s-mute" data-bs-toggle="tooltip" title="pe-7s-mute"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-power"
                  ...
                  <li>
                    <i class="pe-7s-plus" data-bs-toggle="tooltip" title="pe-7s-plus"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-play" data-bs-toggle="tooltip" title="pe-7s-play"></i>
                  </li>
                  <li>
                  ...
                  <li>
                    <i class="pe-7s-plug" data-bs-toggle="tooltip" title="pe-7s-plug"></i>
                  </li>
                  <li>
                  ...
                  <li>
                    <i class="pe-7s-note" data-bs-toggle="tooltip" title="pe-7s-note"></i>
                  </li>
                  <li>
                    <i class="pe-7s-next" data-bs-toggle="tooltip" title="pe-7s-next"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-more" data-bs-toggle="tooltip" title="pe-7s-more"></i>
                  </li>
                  <li>
                    <i class="pe-7s-moon" data-bs-toggle="tooltip" title="pe-7s-moon"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-monitor"
                  ...
                  <li>
                    <i class="pe-7s-menu" data-bs-toggle="tooltip" title="pe-7s-menu"></i>
                  </li>
                  <li>
                  ...
                  <li>
                    <i class="pe-7s-mail" data-bs-toggle="tooltip" title="pe-7s-mail"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-loop" data-bs-toggle="tooltip" title="pe-7s-loop"></i>
                  </li>
                  <li>
                    <i class="pe-7s-look" data-bs-toggle="tooltip" title="pe-7s-look"></i>
                  </li>
                  <li>
                    <i class="pe-7s-lock" data-bs-toggle="tooltip" title="pe-7s-lock"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-lintern"
                  ...
                  <li>
                    <i class="pe-7s-link" data-bs-toggle="tooltip" title="pe-7s-link"></i>
                  </li>
                  <li>
                    <i class="pe-7s-like" data-bs-toggle="tooltip" title="pe-7s-like"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-light"
                  ...
                  <li>
                    <i class="pe-7s-less" data-bs-toggle="tooltip" title="pe-7s-less"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-keypad"
                  ...
                  <li>
                    <i class="pe-7s-junk" data-bs-toggle="tooltip" title="pe-7s-junk"></i>
                  </li>
                  <li>
                    <i class="pe-7s-info" data-bs-toggle="tooltip" title="pe-7s-info"></i>
                  </li>
                  <li>
                    <i class="pe-7s-home" data-bs-toggle="tooltip" title="pe-7s-home"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-help2"
                  ...
                  <li>
                    <i class="pe-7s-gift" data-bs-toggle="tooltip" title="pe-7s-gift"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-folder"
                  ...
                  <li>
                    <i class="pe-7s-flag" data-bs-toggle="tooltip" title="pe-7s-flag"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-filter"
                  ...
                  <li>
                    <i class="pe-7s-file" data-bs-toggle="tooltip" title="pe-7s-file"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-expand1"
                  ...
                  <li>
                    <i class="pe-7s-edit" data-bs-toggle="tooltip" title="pe-7s-edit"></i>
                  </li>
                  <li>
                    <i class="pe-7s-drop" data-bs-toggle="tooltip" title="pe-7s-drop"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-drawer"
                  ...
                  <li>
                    <i class="pe-7s-date" data-bs-toggle="tooltip" title="pe-7s-date"></i>
                  </li>
                  <li>
                  ...
                  <li>
                    <i class="pe-7s-crop" data-bs-toggle="tooltip" title="pe-7s-crop"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-credit"
                  ...
                  <li>
                    <i class="pe-7s-chat" data-bs-toggle="tooltip" title="pe-7s-chat"></i>
                  </li>
                  <li>
                    <i class="pe-7s-cart" data-bs-toggle="tooltip" title="pe-7s-cart"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-camera"
                  ...
                  <li>
                    <i class="pe-7s-call" data-bs-toggle="tooltip" title="pe-7s-call"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-box2" data-bs-toggle="tooltip" title="pe-7s-box2"></i>
                  </li>
                  <li>
                    <i class="pe-7s-box1" data-bs-toggle="tooltip" title="pe-7s-box1"></i>
                  </li>
                  <li>
                    <i
                  ...
                  <li>
                    <i class="pe-7s-bell" data-bs-toggle="tooltip" title="pe-7s-bell"></i>
                  </li>
                  <li>
                    <i
                      class="pe-7s-battery"
                  ...
                  <li>
                    <i class="pe-7s-ball" data-bs-toggle="tooltip" title="pe-7s-ball"></i>
                  </li>
                  <li>
                    <i class="pe-7s-back" data-bs-toggle="tooltip" title="pe-7s-back"></i>
                  </li>
                  <li>
                    <i
