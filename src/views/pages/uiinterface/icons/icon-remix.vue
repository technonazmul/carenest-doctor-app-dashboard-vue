  ...
  <div class="page-wrapper cardhead">
    ...
    <div class="content">
      ...
      <div class="page-header">
        <div class="row">
          <div class="col-sm-12">
            <h3 class="page-title">Remix Icon</h3>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="mb-2">
                <code>&lt;i class="ri-ICON_NAME"&gt;&lt;/i&gt;</code>. For more
                information
                <a href="https://remixicon.com/" target="_blank" class="text-primary"
                  >click here</a
                >.
              </p>
