      ...
      <div class="row">
            ...
            <div class="card-body">
              <div class="d-flex flex-wrap gap-2">
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-info dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Info
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-warning dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Warning
            ...
            <div class="card-body">
              <div class="d-flex flex-wrap gap-2">
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-primary dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Primary
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-secondary dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Secondary
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-success dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Success
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-info dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Info
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-warning dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Warning
                ...
                <div class="btn-group">
                  <button
                    type="button"
                    class="btn btn-soft-danger dropdown-toggle rounded-pill"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    Danger
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted mb-3">
                Use <code>.dropup-center</code> on the parent element.
              </p>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted mb-3">
                You can use <code>&lt;a&gt;</code> or <code>&lt;button&gt;</code> as
                dropdown items.
              </p>
              <div class="dropdown">
                <button
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p>
                You can use the <code>autoClose</code> option to change this behavior of
                the dropdown.
              </p>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                To align <strong>right</strong> the dropdown menu with the given
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                To align <strong>left</strong> the dropdown menu with the given breakpoint
                or larger, add <code>.dropdown-menu-end</code> and
      ...
      <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-auto">
                  <div class="dropdown">
                    <button
                      class="btn btn-outline-info dropdown-toggle drop-arrow-none"
                      type="button"
                      id="dropdownMenuIcon"
                      data-bs-toggle="dropdown"
                      aria-haspopup="true"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Trigger dropdown menus above elements by adding <code>.dropup</code> to
                the parent element.
              </p>
