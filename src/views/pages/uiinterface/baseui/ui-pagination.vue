        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <nav>
                <ul
                  class="pagination pagination-boxed pagination-gradient pagination-primary"
                >
                  <li class="page-item">
                    <a
                      class="page-link"
              ...
              <nav>
                <ul
                  class="pagination pagination-boxed pagination-secondary pagination-gradient"
                >
                  <li class="page-item">
                    <a
                      class="page-link"
              ...
              <nav>
                <ul
                  class="pagination pagination-boxed pagination-dark pagination-gradient mb-0"
                >
                  <li class="page-item">
                    <a
                      class="page-link"
