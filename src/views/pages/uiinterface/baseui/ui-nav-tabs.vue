            ...
            <div class="card-body">
              ...
              <div class="tab-content">
                <div class="tab-pane" id="home">
                  <p class="mb-0">
                    Welcome to the dashboard! Access key metrics, recent updates, and
                    quick links to manage your activity. Use this panel to stay on top of
                    your workflow and performance goals.
                  </p>
                </div>
                <div class="tab-pane show active" id="profile">
                  <p class="mb-0">
                    Manage your profile details, update your contact info, and review your
                    login activity. Keeping your account information accurate ensures a
                    smooth and secure experience.
                  </p>
                </div>
                <div class="tab-pane" id="message">
                  <p class="mb-0">
                    View recent messages, send new replies, and stay connected with your
                    team. The messaging center helps you manage conversations efficiently
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs nav-solid-primary mb-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#solid-tab3" data-bs-toggle="tab">Messages</a>
                </li>
              </ul>
              <div class="tab-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              <ul
                class="nav nav-tabs nav-solid-success nav-tabs-rounded nav-justified mb-3"
              >
                <li class="nav-item">
                  <a
                    class="nav-link active"
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <ul
                class="nav nav-tabs nav-justified nav-bordered nav-bordered-success mb-3"
              >
                <li class="nav-item">
                  <a
                    href="#home-b2"
                ...
                <div class="col-sm-9">
                  <div class="tab-content" id="v-pills-tabContent">
                    ...
                    >
                      <p class="mb-0">
                        Welcome to the dashboard! Access key metrics, recent updates, and
                        quick links to manage your activity. Use this panel to stay on top
                        of your workflow and performance goals.
                      </p>
                    </div>
                    <div
                      class="tab-pane fade"
                    ...
                    >
                      <p class="mb-0">
                        Manage your profile details, update your contact info, and review
                        your login activity. Keeping your account information accurate
                    ...
                    >
                      <p class="mb-0">
                        View recent messages, send new replies, and stay connected with
                        your team. The messaging center helps you manage conversations
                        efficiently and never miss important updates.
                      </p>
                    </div>
                  </div>
                  <!-- end tab-content-->
