          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                adds extra padding to the right of the alert and positions the
                <code>.btn-close</code> button.
              </p>

              <div
                class="alert alert-primary text-bg-primary alert-dismissible"
                role="alert"
              >
              ...
              <div
                class="alert alert-secondary text-bg-secondary alert-dismissible"
                role="alert"
              >
              ...
              <div
                class="alert alert-success text-bg-success alert-dismissible"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-danger text-bg-danger alert-dismissible"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-warning text-bg-warning alert-dismissible"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-dark text-bg-dark alert-dismissible mb-0"
                role="alert"
              >
                <button
                  type="button"
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Display alert with transparent background and with contextual text color.
                Use classes <code>.bg-white</code>, and <code>.text-*</code>. E.g.
                <code>bg-white text-primary</code>.
              </p>

              <div
                class="alert alert-primary alert-dismissible border border-primary"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-secondary alert-dismissible border border-secondary"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-success alert-dismissible border border-success"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-danger alert-dismissible border border-danger"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-warning alert-dismissible border border-warning"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-info alert-dismissible border border-info"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-light alert-dismissible border border-light"
                role="alert"
              >
                <button
                  type="button"
              ...
              <div
                class="alert alert-dark alert-dismissible border border-dark mb-0"
                role="alert"
              >
                <button
                  type="button"
