      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item">
                  <i class="ti ti-brand-nextcloud me-1 align-middle fs-18"></i> Nextcloud
                  File Sharing
                </li>
                <li class="list-group-item">
                  <i class="ti ti-brand-zoom me-1 align-middle fs-18"></i> Zoom Video
                  Meetings
                </li>
                <li class="list-group-item">
        ...
        <div class="col-xl-4">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Add <code>.active</code> to a <code>.list-group-item</code> to indicate
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p>
                ...
                items from vertical to horizontal across all breakpoints. Alternatively,
                choose a responsive variant
                <code>.list-group-horizontal-{sm|md|lg|xl|xxl}</code> to make a list group
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                customize as needed. You can use them without <code>&lt;label&gt;</code>s,
                but please remember to include an <code>aria-label</code> attribute and
