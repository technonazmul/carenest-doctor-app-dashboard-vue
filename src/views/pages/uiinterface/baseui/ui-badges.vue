      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-xl mb-3">
                Use the <span class="text-secondary">badge</span> class to show a default
                badge.
              </p>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p>
                Use the <code>.rounded-pill</code> to create a soft badge more rounded.
              </p>
              <div class="d-flex flex-wrap gap-2">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-xl mb-3">
                Use the <code>badge-soft-</code> class to create a softer badge.
              </p>
              <div class="d-flex flex-wrap gap-2">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-xl mb-3">
                Use the <code>rounded-pill badge-soft-</code> to create a soft badge more
                rounded
              </p>
              <div class="d-flex flex-wrap gap-2">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-xl mb-3">
                Use the <code>badge-outline-</code> to create a badge with the outline.
              </p>
              <div class="d-flex flex-wrap gap-2">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-xl mb-3">
                Use the <code>rounded-pill badge-outline-</code> class to create a outline
                pill badge.
              </p>
              <div class="d-flex flex-wrap gap-2">
                ...
                <span class="badge rounded-pill badge-outline-light text-dark"
                  >Light</span
                >
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap gap-2">
                <span class="badge badge-soft-primary border border-primary"
                  >Primary</span
                >
                <span class="badge badge-soft-secondary border border-secondary"
                  >Secondary</span
                >
                <span class="badge badge-soft-success border border-success"
                  >Success</span
                >
                <span class="badge badge-soft-danger border border-danger">Danger</span>
                <span class="badge badge-soft-warning border border-warning"
                  >Warning</span
                >
                <span class="badge badge-soft-info border border-info">Info</span>
                <span class="badge badge-soft-light border border-light text-dark"
                  >Light</span
                >
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap gap-2">
                <span class="badge rounded-pill badge-soft-primary border border-primary"
                  >Primary</span
                >
                <span
                  class="badge rounded-pill badge-soft-secondary border border-secondary"
                  >Secondary</span
                >
                <span class="badge rounded-pill badge-soft-success border border-success"
                  >Success</span
                >
                <span class="badge rounded-pill badge-soft-danger border border-danger"
                  >Danger</span
                >
                <span class="badge rounded-pill badge-soft-warning border border-warning"
                  >Warning</span
                >
                <span class="badge rounded-pill badge-soft-info border border-info"
                  >Info</span
                >
                <span
                  class="badge rounded-pill badge-soft-light border border-light text-dark"
                  >Light</span
                >
                <span class="badge rounded-pill badge-soft-dark border border-dark"
                  >Dark</span
                >
              </div>
            </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body d-flex flex-wrap gap-4">
              ...
              <button
                type="button"
                class="btn btn-primary btn-md btn-icon position-relative"
              >
              ...
              <button
                type="button"
                class="btn btn-light rounded-circle btn-md btn-icon position-relative"
              >
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h5 class="mb-3">
                Example heading <span class="badge bg-warning">New</span>
              </h5>
              <h6 class="mb-0">
