    ...
    <div class="content">
      <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
        <div class="flex-grow-1">
          <h4 class="fs-18 fw-semibold mb-0">Utilities</h4>
        </div>
          ...
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                background image to the backgrounds. This gradient starts with a
                ...
                <div class="col-12">
                  <div class="d-flex flex-column gap-2">
                    <div class="bg-primary-subtle p-2">
                      <code class="text-primary-emphasis">.bg-primary-subtle</code>
                    </div>
                    <div class="bg-secondary-subtle p-2">
                      <code class="text-secondary-emphasis">.bg-secondary-subtle </code>
                    </div>
                    <div class="bg-success-subtle p-2">
                      <code class="text-success-emphasis">.bg-success-subtle</code>
                    </div>
                    <div class="bg-danger-subtle p-2">
                      <code class="text-danger-emphasis">.bg-danger-subtle</code>
                    </div>
                    <div class="bg-warning-subtle p-2">
                      <code class="text-warning-emphasis">.bg-warning-subtle</code>
                    </div>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                <code>background-color</code> utilities are generated with Sass using CSS
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Colorize text with color utilities. If you want to colorize links, you can
                use the <code>.link-*</code> helper classes which have
          ...
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>1</code> is not transparent at all, <code>.5</code> is 50% visible,
                and <code>0</code> is completely transparent. Set the
                <code>opacity</code> of an element using
                <code>.opacity-{value}</code> utilities.
              </p>
              <div class="d-flex flex-wrap gap-2">
                <div class="opacity-100 p-2 bg-primary text-light fw-bold rounded">
                  100%
                </div>
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use border utilities to <b>add</b> an element’s borders. Choose from all
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use border utilities to <b>remove</b> an element’s borders. Choose from
              ...
              <div class="d-flex align-items-start flex-wrap gap-4">
                ...
                <div class="text-center">
                  <div
                    class="border border-bottom-0 avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-start-0 avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-start flex-wrap gap-2">
                <div class="text-center">
                  <div
                    class="border border-primary avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-secondary avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-success avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-danger avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-warning avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-start flex-wrap gap-2">
                <div class="text-center">
                  <div
                    class="border border-primary-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-secondary-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-success-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-danger-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-warning-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                  <div
                    class="border border-info-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                  <div
                    class="border border-dark-subtle avatar-xl bg-light bg-opacity-50"
                  ></div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the scaling classes for larger or smaller rounded corners. Sizes range
                from <code>0</code> to <code>5</code>.
              </p>
              <div class="d-flex align-items-start flex-wrap gap-2">
                <img
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>user-select-none</code> class to the content which is selected when
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code> classes
              ...
              <p>
                <a href="#" class="pe-auto">This link</a> can be clicked (this is default
                behavior).
              </p>
              <p class="pe-none">
                <a href="#" tabindex="-1" aria-disabled="true">This link</a> can not be
                clicked because the <code>pointer-events</code> property is inherited from
                its parent. However, <a href="#" class="pe-auto">this link</a> has a
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-wrap gap-3">
                ...
                >
                  ...
                  elementwith set width and height dimensions.
                </div>
                <div
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                class <code>.translate-middle</code>.
              </p>
              <!-- Center elements -->
              <div
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>.translate-middle-y</code> classes, elements can be positioned only
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                remove a shadow with our <code>box-shadow</code> utility classes. Includes
                support for <code>.shadow-none</code> and three default sizes (which have
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                >
                with our responsive <code>object-fit</code> utility classes. This property
                tells the content to fill the parent container in a variety of ways, such
                as preserving the aspect ratio or stretching to take up as much space as
                possible.
              </p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="bd-example-zindex-levels position-relative">
                <div class="z-3 position-absolute p-5 rounded-3 bg-primary">
                  <span>z-3</span>
                </div>
                <div class="z-2 position-absolute p-5 rounded-3 bg-success">
                  <span>z-2</span>
                </div>
                <div class="z-1 position-absolute p-5 rounded-3 bg-warning">
                  <span>z-1</span>
                </div>
                <div class="z-0 position-absolute p-5 rounded-3 bg-danger">
                  <span>z-0</span>
                </div>
                <div class="z-n1 position-absolute p-5 rounded-3 bg-info">
                  <span>z-n1</span>
                </div>
              </div>
            </div>
