      ...
      <div class="row">
        ...
        <div class="col-xl-4">
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p class="text-muted">
                Remove a list's bullets and apply some light margin with a combination of
                two classes, .list-inline and .list-inline-item.
              </p>
              <ul class="list-inline">
          ...
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                Wrap <code>&lt;blockquote class="blockquote"&gt;</code> around any
                <abbr title="PacesText Markup Language">HTML</abbr> as the quote.
              </p>
              <blockquote class="blockquote">
                <p class="mb-0">
