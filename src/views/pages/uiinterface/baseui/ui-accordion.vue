          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>background-color</code>, some borders, and some rounded corners to
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Using the card component, you can extend the default collapse behavior to
                create an accordion. To properly achieve the accordion style, be sure to
                use <code>.accordion</code> as a wrapper.
              </p>
          ...
          <div class="card card-h-100">
            ...
            <div class="card-body">
              <p class="text-muted">
                ...
                <code>.accordion-collapse</code> to make accordion items stay open when
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div
                class="accordion accordion-arrow-none"
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-primary</code> to create a solid primary
                accordion.
              </p>
              <div
                class="accordion accordion-solid-primary"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-secondary</code> to create a solid
                secondary accordion.
              </p>
              <div
                class="accordion accordion-solid-secondary"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-warning</code> to create a solid warning
                accordion.
              </p>
              <div
                class="accordion accordion-solid-warning"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-info</code> to create a solid info
                accordion.
              </p>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-success</code> to create a solid success
                accordion.
              </p>
              <div
                class="accordion accordion-solid-success"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-solid-danger</code> to create a solid danger
                accordion.
              </p>
              <div
                class="accordion accordion-solid-danger"
      ...
      <div class="row">
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-primary</code> to create a primary border
                accordion.
              </p>
              <div
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-secondary</code> to create a secondary
                border accordion.
              </p>
              <div
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-success</code> to create a success border
                accordion.
              </p>
              <div
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-info</code> to create a info border
                accordion.
              </p>
              <div
                class="accordion accordion-border-info accordions-items-seperate"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-warning</code> to create a warning border
                accordion.
              </p>
              <div
                class="accordion accordion-border-warning accordions-items-seperate"
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-muted">
                Use the <code>.accordion-border-danger</code> to create a danger border
                accordion.
              </p>
              <div
                class="accordion accordion-border-danger accordions-items-seperate"
