        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button type="button" id="ajax-alert" class="btn btn-secondary">
                Click Me
              </button>
            </div>
            <!-- end card-body -->
...
export default {
  ...
  methods: {
    ...
    titleAlert() {
      this.$swal({
        title: "Custom Title",
        text: "This is an alert with a title!",
        icon: "info",
      });
    },
    htmlAlert() {
      this.$swal({
        ...
        html: "You can <b>format</b> your text!",
        icon: "warning",
      });
    },
    confirmAlert() {
