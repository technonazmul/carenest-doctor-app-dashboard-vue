            ...
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <span
                  ...
                  ><i class="ti ti-arrow-up-right-circle fs-24"></i
                ></span>
              </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <span
                  ...
                  ><i class="ti ti-arrow-down-right-circle fs-24"></i
                ></span>
              </div>
              <div class="p-2 rounded bg-light text-center">
                <p class="mb-0 fs-13">
          ...
          <div class="card shadow-sm flex-fill w-100">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between mb-2">
                ...
                <span
                  class="avatar avatar-lg bg-danger text-white rounded-circle border border-danger flex-shrink-0"
