  ...
  <div class="page-wrapper">
    ...
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          <p>
            At Preclinic, we value your privacy and are committed to protecting
            your personal data. This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you access and
            use our Preclinic Platform, including features and content related
            to mental wellness, sleep patterns, dream journaling, and
            early-stage healthcare services.
          </p>
          ...
          <div class="mb-3">
            ...
            <ul class="unorder-list">
              ...
              <li class="list-item">
                <p class="fw-medium">
                  <span class="text-dark"
                    >Health and Wellness Information :</span
                  >
                  Medical conditions (past and current), Allergies and
                  medications, Diagnostic results (lab tests, imaging reports),
                  Treatment records and progress notes.
                </p>
              </li>
              <li class="list-item">
                <p class="fw-medium">
                  <span class="text-dark">Optional Information :</span>
          ...
          <div class="mb-0">
            ...
            <p class="mb-0">
              ...
              will always be available on the platform. Continued use of the
              Preclinic platform signifies your acceptance of any updates.
            </p>
          </div>
        </div>
        <!-- end card body -->
