              ...
              <div class="row row-gap-3">
                <div class="col-md-4">
                  <div class="border shadow-sm p-3 rounded-2">
                    ...
                    <p class="mb-0">
                      <span class="text-dark fw-semibold">258</span> Bookings
                    </p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="border shadow-sm p-3 rounded-2">
                    ...
                    <p class="mb-0">
                      <span class="text-dark fw-semibold">125</span> Bookings
                    </p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="border shadow-sm p-3 rounded-2">
                    ...
                    <p class="mb-0">
                      <span class="text-dark fw-semibold">115</span> Bookings
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-4 d-flex">
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body">
              <div id="circle-chart" class="chart-set">
                <apexchart
                  type="donut"
                  height="270"
                  width="100%"
                  :options="adminCircleChart.sChartCircle"
                  :series="adminCircleChart.series"
                ></apexchart>
              </div>
              <div
                class="d-flex align-items-center flex-wrap justify-content-center gap-2 mt-3"
              >
                ...
                <p class="d-flex align-items-center mb-0 fs-13">
                  ...
                  ><span class="text-dark fw-semibold me-1">150</span> Dental
                </p>
                <p class="d-flex align-items-center mb-0 fs-13">
                  <i class="ti ti-circle-filled text-primary fs-10 me-1"></i
                  ><span class="text-dark fw-semibold me-1">121</span> Neurolgy
                </p>
              </div>
            </div>
          </div>
                ...
                <table class="table border">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span
                          class="badge fs-13 py-1 badge-soft-danger border border-danger rounded fw-medium"
                          >Cancelled</span
                        >
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <span
                          class="badge fs-13 py-1 badge-soft-secondary border border-secondary rounded fw-medium"
                          >Checked Out</span
                        >
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <span
                          class="badge fs-13 py-1 badge-soft-info border border-info rounded fw-medium"
                          >Schedule</span
                        >
                      </td>
                    </tr>
...
export default {
  ...
  setup() {
    ...
    const layoutType = computed(() => {
      return route.path === "/layout/layout-hover-view" ? "hoverview" : "";
    });
    ...
    const updateHtmlAndBody = () => {
      ...
      if (route.path === "/layouts/layout-hover-view") {
        document.body.classList.add("hoverview");
      } else {
        document.body.classList.remove("hoverview");
      }
    };
