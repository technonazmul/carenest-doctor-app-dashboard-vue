            ...
            <div class="card flex-fill mb-0 border-0 bg-light-500 shadow-none">
              <div class="card-header border-bottom px-0 mx-3">
                <div class="d-flex align-items-center justify-content-between">
                  <h5 class="fw-bold">System Update</h5>
                  <a
              ...
              <div class="card-body px-0 mx-3">
                <div class="d-flex align-items-center mb-3">
                  <span
                    class="p-2 bg-light rounded-circle d-inline-flex align-items-center justify-content-center text-primary me-1"
                    ><i class="ti ti-circle-check-filled fs-20"></i
                  ></span>
                  <div>
                    <div class="d-flex align-items-center mb-1">
                      <h6 class="fs-14 mb-0 me-2">You are up to date</h6>
                      <span
                        class="badge badge-soft-primary border border-primary fw-medium"
                        >Current Version : 8.0</span
                      >
                    </div>
                    <span class="fs-13">Last Checked : Today 10:30 AM</span>
                  </div>
                </div>
