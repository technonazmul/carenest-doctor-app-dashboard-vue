                  ...
                  <div class="card-header border-bottom px-0 mx-3">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <a
                        ...
                        ><i class="ti ti-plus me-1"></i>New Tax Group</a
                      >
                    </div>
                  </div>
                  <div class="card-body px-0 mx-3">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label class="form-label"
                >Tax Name<span class="text-danger ms-1">*</span></label
              >
              <input type="text" class="form-control" />
            </div>
            <div class="mb-0">
              <label class="form-label"
                >Tax Rate (%)<span class="text-danger ms-1">*</span></label
              >
              <input type="text" class="form-control" />
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <form>
          <div class="modal-body">
            ...
            <div class="mb-0">
              <label class="form-label"
                >Sub Taxes<span class="text-danger ms-1">*</span></label
              >
              <vue3-tags-input
