    ...
    <div class="content">
      ...
      >
        ...
        <div class="text-end d-flex">
          ...
          <router-link
            ...
            ><i class="ti ti-plus me-1"></i>New Doctor</router-link
          >
        </div>
      </div>
      <!-- End Page Header -->
      ...
      <div class="row">
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div
              class="card-body d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3"
            >
              ...
              <div class="flex-fill">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="text-primary fs-14 mb-0">
                  ...
                  <router-link
                    ...
                    class="avatar avatar-xs border text-muted fs-14"
      ...
      <div class="text-center">
        <a href="#" class="btn btn-white bg-white text-dark fs-13"
          >Load More<span class="spinner-border spinner-border-sm ms-1"></span
        ></a>
      </div>
    </div>
    <!-- End Content -->
        ...
        <div class="modal-body text-center position-relative z-1">
          ...
          <div class="d-flex justify-content-center">
            ...
            <router-link
              ...
              class="btn btn-primary position-relative z-1"
