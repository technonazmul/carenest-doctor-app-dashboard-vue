<template>
  ...
  <div class="page-wrapper">
    ...
    <div class="content">
      <!-- Start Page Header -->
      <div
        class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 mb-4"
      >
        ...
        <div class="text-end d-flex">
          ...
          <router-link
            to="/patients/create-patient"
            class="btn btn-primary ms-2 fs-13 btn-md"
            ><i class="ti ti-plus me-1"></i>New Patient</router-link
          >
        </div>
      </div>
      <!-- End Page Header -->
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-2 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-calendar me-1 text-dark"></i>Last Appointment :
                Mon, 30 Apr 2025
              </p>
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Green Square,
                New York, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Lakeview Drive,
                Chicago, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Ocean Avenue,
                Miami, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Elm Road,
                Austin, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Maple Street,
                San Francisco, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Pine Valley,
                Seattle, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>River Walk,
                Houston, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Forest Hill,
                Denver, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Garden Circle,
                Orlando, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Crystal Court,
                Atlanta, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Oakwood Street,
                Phoenix, USA
              </p>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-0 text-truncate fs-13 d-flex align-items-center">
                <i class="ti ti-location-pin me-1 text-dark"></i>Hilltop Lane,
                Dallas, USA
              </p>
            </div>
          </div>
      ...
      <div class="text-center">
        <a href="javascript:void(0);" class="btn btn-outline-white bg-white"
          >Load More<i class="ti ti-loader-2 ms-1"></i
        ></a>
      </div>
    </div>
    <!-- End Content -->
