      ...
      >
        ...
        <div class="row">
          <div class="col-lg-6 p-0">
            ...
            >
              <img
                src="@/assets/img/auth/success-illustration-img.png"
                    ...
                    <div class="card border-1 p-lg-3 shadow-md rounded-3 mb-4">
                      <div class="card-body">
                        <div class="mb-3 text-center">
                          <span
                            ><i class="ti ti-circle-check-filled fs-48 text-success"></i
                          ></span>
                        </div>
                        <div class="text-center mb-3">
                          <h5 class="mb-1 fs-20 fw-bold">Success</h5>
                          <p class="mb-0">
...
export default {
  ...
  methods: {
    submitForm() {
      this.$router.push("/login-illustration");
    },
  },
};
</script>
