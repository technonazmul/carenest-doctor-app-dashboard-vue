<template>
  ...
  <div class="page-wrapper">
    ...
    <div class="content p-0">
      <div class="d-md-flex">
        <!-- Email Sidenav Start -->
        <div
          class="email-sidebar border-end border-bottom bg-white w-100"
          data-simplebar=""
        >
          <div class="p-3">
            ...
            <a href="javascript:void(0);" class="btn btn-primary w-100" id="compose_mail"
              ...
              <div class="d-block mb-3 pb-3 border-bottom">
                ...
                <div>
                  <div class="more-menu">
                    ...
                    >
                      <span class="d-flex align-items-center fw-medium"
                        ><i class="ti ti-location-up text-gray me-2"></i>Important</span
                      >
                      <span class="rounded-pill">12</span>
                    </a>
                    <a
                  ...
                  <div class="view-all mt-2">
                    <a href="javascript:void(0);" class="viewall-button text-muted"
            ...
            <div class="border-bottom mb-3 pb-3">
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="view-all mt-2">
                    <a href="javascript:void(0);" class="viewall-button-2 text-muted"
                      ><span>Show More</span></a
                    >
                  </div>
                </div>
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="view-all mt-2">
                    <a href="javascript:void(0);" class="viewall-button-3 text-muted"
                      ><span>Show More</span></a
                    >
                  </div>
                </div>
        ...
        <div
          class="bg-white flex-fill border-end border-bottom mail-notifications"
          data-simplebar=""
        >
          <div class="active">
            <div>
              ...
              <div class="list-group list-group-flush mails-list">
                ...
                <div class="list-group-item p-3">
                  <div class="d-flex align-items-center mb-2">
                    <div
                      class="form-check form-check-md d-flex align-items-center flex-shrink-0 me-2"
                    >
                      <input class="form-check-input" type="checkbox" />
                    </div>
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <router-link
                        to="/applications/email-reply"
                        class="avatar bg-primary avatar-rounded me-2"
                      >
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          <div>
                            <h6 class="fs-16 mb-1">
                              <router-link to="/applications/email-reply"
                                >Justin Lapoint</router-link
                              >
                            </h6>
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <span class="d-inline-flex align-items-center"
                              ><i class="ti ti-point-filled text-success"></i>3:13
                              PM</span
                            >
                          </div>
                        </div>
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span class="d-flex align-items-center btn btn-sm bg-soft-dark me-2"
                        ><i class="ti ti-folder-open me-2"></i>3</span
                      >
                      <span class="d-flex align-items-center btn btn-sm bg-soft-dark"
                        ><i class="ti ti-photo me-2"></i>+24</span
                      >
                    </div>
                    <div class="d-flex align-items-center">
                      <span><i class="ti ti-star-filled text-warning"></i></span>
                      <span
                        class="badge badge-soft-info mx-2 d-inline-flex align-items-center p-1"
                        ><i class="ti ti-square me-1"></i>Projects</span
                      >
                      <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1"
                        >+1</a
                      >
                    </div>
                  </div>
                ...
                <div class="list-group-item p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <router-link
                        to="/applications/email-reply"
                        class="avatar avatar-md avatar-rounded me-2"
                      >
                      ...
                      <div class="flex-fill">
                        <div class="d-flex align-items-start justify-content-between">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <span class="d-inline-flex align-items-center"
                              ><i class="ti ti-point-filled text-danger"></i>3:13 PM</span
                            >
                          </div>
                        </div>
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span><i class="ti ti-star-filled text-warning"></i></span>
                      <span
                        class="badge badge-soft-primary d-inline-flex align-items-center p-1 mx-2"
                        ><i class="ti ti-square me-1"></i>Applications</span
                      >
                      <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1"
                        >+1</a
                      >
                ...
                <div class="list-group-item p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span
                        class="d-flex align-items-center btn btn-sm bg-soft-dark fs-14"
                        ><i class="ti ti-video me-2"></i>1</span
                      >
                    </div>
                    <div class="d-flex align-items-center">
                      <span><i class="ti ti-star-filled text-warning"></i></span>
                      <span
                        class="badge badge-soft-danger d-inline-flex align-items-center p-1 mx-2"
                        ><i class="ti ti-square me-1"></i>External</span
                      >
                      <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1"
                        >+1</a
                      >
                ...
                <div class="list-group-item p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span class="d-flex align-items-center btn btn-sm bg-soft-dark"
                        ><i class="ti ti-photo me-2"></i>1</span
                      >
                    </div>
                    <div class="d-flex align-items-center">
                      <span
                        class="badge badge-soft-success d-inline-flex align-items-center p-1"
                        ><i class="ti ti-square me-1"></i>Team Events</span
                      >
                    </div>
                  </div>
                </div>
                ...
                <div class="list-group-item p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <span class="d-flex align-items-center btn btn-sm bg-soft-dark"
                        ><i class="ti ti-link me-2"></i>1</span
                      >
                    </div>
                    <div class="d-flex align-items-center">
                      <span
                        class="badge badge-soft-danger me-2 d-inline-flex align-items-center p-1"
                        ><i class="ti ti-square me-1"></i>External</span
                      >
                      <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1"
                        >+1</a
                ...
                <div class="list-group-item p-3">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span
                        class="badge badge-soft-warning me-2 d-inline-flex align-items-center p-1"
                        ><i class="ti ti-square me-1"></i>Work</span
                      >
                      <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1"
                        >+1</a
                      >
                ...
                <div class="list-group-item p-3">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                      <router-link
                        to="/applications/email-reply"
                        class="avatar bg-success avatar-rounded me-2"
                      >
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                      <span
                        class="badge badge-soft-info d-inline-flex align-items-center p-1"
                        ><i class="ti ti-square me-1"></i>Projects</span
                      >
                    </div>
                  </div>
  ...
  <div
    id="compose-view"
    class="position-fixed top-0 start-0 w-100 h-100 align-items-end justify-content-end"
  >
    <div class="bg-white border-0 rounded compose-view position-relative">
      <div
        class="compose-header d-flex align-items-center justify-content-between bg-dark p-3"
      >
        ...
        <div class="d-flex align-items-center">
          ...
          ></a>
          <button
            class="bg-transparent border-0 fs-16 text-white position-static p-0"
            id="compose-close"
          >
      ...
      <form>
        <div class="p-3 position-relative pb-2 border-bottom">
          ...
          <div
            class="d-flex align-items-center position-absolute end-0 pe-3 top-50 translate-middle-y"
          >
