      ...
      <div class="row">
              ...
              <div class="card-body">
                  ...
                  <div class="row g-2">
                    <div class="col-sm-6">
                      <div class="rounded bg-white text-center p-2">
                        <h6 class="fs-16 mb-1">89K</h6>
                        <p class="fs-13 mb-0">Followers</p>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="rounded bg-white text-center p-2">
                        <h6 class="fs-16 mb-1">45</h6>
                        <p class="fs-13 mb-0">Follows</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="mb-3">
                  <a
                    ...
                    ><i class="ti ti-circle-plus me-2"></i>Create Post</a
                  >
                </div>
                <div class="files-list border-bottom pb-2 mb-3">
                  ...
                  <a
                    ...
                    ><i class="ti ti-mood-search me-2"></i>Explore</a
                  >
                  <a
                    href="javscript:void(0);"
                    class="d-flex align-items-center fw-medium p-2"
                    ><i class="ti ti-mail-check me-2"></i>Messages</a
                  >
                  <a
                    href="javscript:void(0);"
                    class="d-flex align-items-center fw-medium p-2"
                    ><i class="ti ti-list me-2"></i>Lists</a
                  >
                  <a
                    href="javscript:void(0);"
                    class="d-flex align-items-center fw-medium p-2"
                    ><i class="ti ti-bookmark me-2"></i>Bookmark</a
                  >
                  <a
                    href="javscript:void(0);"
                    class="d-flex align-items-center fw-medium p-2"
                    ><i class="ti ti-coffee me-2"></i>Marketplace</a
                  >
                  <a
                    href="javscript:void(0);"
                  ...
                  <a
                    href="javscript:void(0);"
                    class="d-flex align-items-center fw-medium p-2"
                    ><i class="ti ti-user-share me-2"></i>Profile</a
                  >
                </div>
                <div>
                  <!-- Visible Items -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                  <h6 class="fs-16 mb-0">Popular Channels</h6>
                </div>
                <div
                  class="d-flex align-items-center justify-content-between flex-wrap row-gap-3"
                >
              ...
              <div class="card-body">
                ...
                <div class="card shadow-none mb-3">
                  <div class="card-img card-img-hover rounded-0">
                    <a href="javascript:void(0);" class="rounded-top"
                      ><img
        ...
        <div class="col-xl-3 theiaStickySidebar">
          <div class="stickysidebar">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <h6 class="text-center fs-14">
                  <a href="javascript:void(0);"
                    >Enjoy Unlimited Access on a small price monthly.</a
                  >
                </h6>
                <div class="mt-3">
                  <a
            ...
            <div
              class="d-flex align-items-center flex-wrap justify-content-center gap-2 mb-3"
            >
  ...
  data() {
    return {
      ...
      links: [
        ...
        {
          title: "UI/UX Designs",
          Image: "liked-page-02.svg",
        },
        {
          title: "Figma Update",
          Image: "liked-page-03.svg",
        },
        {
          title: "I Am Techie",
