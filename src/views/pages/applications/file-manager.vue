    ...
    <div class="content">
      ...
      >
        ...
        <div class="mb-2">
          <a
            ...
            ><i class="ti ti-circle-plus me-1"></i>Create Folder</a
          >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-9">
          ...
          <div class="border-bottom mb-3">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 d-flex">
                <div
                  class="bg-white d-flex align-items-center justify-content-between border p-2 rounded mb-3 flex-fill"
                >
                  <div class="d-flex align-items-center">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                          <a
                            ...
                            data-bs-target="#preview"
                            class="dropdown-item rounded-1"
                            ><i class="ti ti-folder-open me-2"></i>Preview</a
                          >
                        </li>
                        <li>
                          <a
          ...
          <div class="border-bottom mb-3">
            <div
              class="d-flex align-items-center justify-content-between mb-2 table-header"
            >
              <h6 class="mb-2">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="rounded border mb-3">
                  <div
                    class="bg-transparent-dark p-5 d-flex align-items-center justify-content-center rounded-top"
                  >
  ...
  <div class="sidebar-themesettings offcanvas offcanvas-end" id="preview">
    ...
    <div class="offcanvas-body p-0">
      ...
      <div class="p-3">
        ...
        <div
          class="border rounded d-flex align-items-center justify-content-between p-2 pb-0 gx-2 mb-3"
        >
            ...
            <ul class="recent-activity mb-3">
              <li class="d-flex pb-2">
                ...
                <div class="ms-2 flex-grow-1">
                  <p class="mb-0">
                    <span class="text-dark">Mercy</span> Added New File in
                    <span class="text-dark">Drive</span>
                  </p>
              ...
              <li class="d-flex">
                ...
                <div class="ms-2 flex-grow-1">
                  <p class="mb-0">
                    <span class="text-dark">Druman</span> Added New File in
                    <span class="text-dark">ROOT FOLDER</span>
                  </p>
            ...
            <ul class="recent-activity mb-3">
              <li class="d-flex pb-2">
                ...
                <div class="ms-2 flex-grow-1">
                  <p class="mb-0">
                    <span class="text-dark">Mercy</span> Added New File in
                    <span class="text-dark">Personal Assets</span>
                  </p>
                  <p class="mb-0">05:22 PM</p>
                  <div
                    class="bg-light rounded p-2 d-flex align-items-center justify-content-between mt-1"
              ...
              <li class="d-flex">
                ...
                <div class="ms-2 flex-grow-1">
                  <p class="mb-0">
                    <span class="text-dark">Jackson</span> Added New File in
                    <span class="text-dark">Drive</span>
                  </p>
                  <p class="mb-0">05:23 PM</p>
                  <div
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        <div class="modal-body text-center">
          <span
            class="d-inline-flex align-items-center justify-content-center p-2 rounded-circle bg-danger mb-2"
            ><i class="ti ti-trash fs-24 text-white"></i
          ></span>
          <h5 class="fw-medium mb-3">Are you sure to delete file?</h5>
          <div class="d-flex">
            <button
              type="button"
              class="btn btn-sm btn-light me-2 w-100"
              data-bs-dismiss="modal"
            >
              Cancel
            </button>
