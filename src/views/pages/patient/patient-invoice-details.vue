          ...
          <div class="d-flex align-items-sm-center flex-sm-row flex-column mb-4">
            <div class="flex-grow-1">
              <h6 class="fs-14 fw-semibold mb-0 d-flex align-items-center">
                <router-link to="/patient/patient-invoices" class="me-1"
                  ><i class="ti ti-chevron-left"></i> Patient Invoice Details</router-link
                >
              </h6>
            </div>
          </div>
              ...
              <div class="row pb-3 border-1 border-bottom mb-4">
                <div class="col-lg-4">
                  ...
                  <p class="text-body mb-1">
                    Invoice Number : <span class="text-dark"> INV0025</span>
                  </p>
                  <p class="text-body mb-1">
                    Issued On : <span class="text-dark"> 25 Jan 2025 </span>
                  </p>
                  <p class="text-body mb-1">
                    Due Date : <span class="text-dark"> 31 Jan 2025</span>
                  </p>
                  <p class="text-body mb-0">
                    Recurring Invoice : <span class="text-dark"> Monthly</span>
                  </p>
                </div>
                <!-- end col -->
                <div class="col-lg-4">
              ...
              <div class="row pb-3 mb-3 border-1 border-bottom">
                <div class="col-lg-6">
                  <div class="">
                    ...
                    <p class="text-body mb-1">
                      Payment Reference :
                      <span class="text-dark"> INV-20250220-001 </span>
                    </p>
                  </div>
                </div>
                <!-- end col -->
