          ...
          <div class="card flex-fill w-100 shadow-sm">
            <div class="card-body">
              <div class="d-flex align-items-center mb-4">
                <span
                  class="avatar bg-primary rounded-circle fs-20 d-inline-flex flex-shrink-0"
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          <div class="card flex-fill w-100 shadow-sm">
            <div class="card-body">
              <div class="d-flex align-items-center mb-4">
                <span
                  class="avatar bg-danger rounded-circle fs-20 d-inline-flex flex-shrink-0"
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          <div class="card flex-fill w-100 shadow-sm">
            <div class="card-body">
              ...
              <div id="s-col-8" class="chart-set">
                <apexchart
                  type="area"
                  height="35"
                  width="100%"
                  :options="sColChart8.sChart8"
                  :series="sColChart8.series"
                ></apexchart>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-3 col-md-6 d-flex">
          <div class="card flex-fill w-100 shadow-sm">
            <div class="card-body">
              ...
              <div id="s-col-9" class="chart-set">
                <apexchart
                  type="area"
                  height="40"
                  width="100%"
                  :options="sColChart9.sChart9"
                  :series="sColChart9.series"
                ></apexchart>
              </div>
            </div>
          </div>
          ...
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body">
              ...
              >
                ...
                <span
                  class="badge fw-medium badge-soft-danger border border-danger flex-shrink-0"
                  >20 Bookings</span
                >
              </div>
              <div
              ...
              <div class="overflow-auto">
                ...
                >
                  ...
                  <div class="d-flex align-items-center">
                    <a
                      href="javascript:void(0);"
                      class="btn btn-outline-white d-inline-flex align-items-center shadow-sm me-2 p-1"
                      ><i class="ti ti-eye"></i
                    ></a>
                    <a
                      href="javascript:void(0);"
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    ...
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">100</span> Kg
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-3 border shadow-sm flex-fill w-100 rounded-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    ...
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">154</span> Cm
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-3 border shadow-sm flex-fill w-100 rounded-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    <p class="mb-1">BMI</p>
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">19.2</span> kg/cm
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-3 border shadow-sm flex-fill w-100 rounded-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    ...
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">97%</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-3 border shadow-sm flex-fill w-100 rounded-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    <p class="mb-1">SPO2</p>
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">98%</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="p-3 border shadow-sm flex-fill w-100 rounded-2">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-1">
                    ...
                    <p class="text-truncate">
                      <span class="fs-18 fw-bold text-dark">101</span> C
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-6 d-flex">
          <div class="card shadow-sm flex-fill w-100">
            ...
            <div class="card-body pb-0">
              <div id="s-col-10" class="chart-set">
                <apexchart
                  type="bar"
                  height="340"
                  :options="sColChart10.sChart10"
                  :series="sColChart10.series"
                ></apexchart>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                    <tr class="border-white">
                      ...
                      <td class="pe-0 text-end">
                        <span
                          class="badge fs-13 py-1 badge-soft-success border border-success rounded text-success fw-medium"
                          >Success</span
                        >
                      </td>
                    </tr>
                    ...
                    <tr class="border-white">
                      ...
                      <td class="pe-0 text-end">
                        <span
                          class="badge fs-13 py-1 badge-soft-danger border border-danger rounded text-danger fw-medium"
                          >Failed</span
                        >
                      </td>
                    </tr>
...
<script>
import { sColChart8, sColChart9, sColChart10 } from "./data";
export default {
  data() {
    return {
      sColChart10: sColChart10,
      sColChart9: sColChart9,
      sColChart8: sColChart8,
    };
  },
};
</script>
